#### Below is a piece of code for the competitor method Network Portrait divergence (NPD)
#### It is taken directly from the Jim Bagrow's Github repository
...
#### arXiv:1804.03665
#### We use the unmodified code below directly for our comparison experiments
